...
})({"87DOC":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "9a540a6afe90e763";
"use strict";
...
},{}],"gJH7z":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _webImmediateJs = require("core-js/modules/web.immediate.js");
var _signViewJs = require("../signViews/signView.js");
...
const signUpHandler = async function(e) {
    ...
    const response = await (0, _signupModelJs.ajaxToServer)("http://127.0.0.1:3000/api/v1/users/signup", data);
    (0, _signViewJsDefault.default).toggleSpinner();
    if (response.status === "success") {
        (0, _signViewJsDefault.default).showScucessMessage(); //TODO
        setTimeout(()=>{
            location.assign("/");
        }, 2000);
    }
    if (response.status === "fail") (0, _signViewJsDefault.default).showError(response); //TODO
};
const setSignUpBtnClickListener = function() {
    (0, _signViewJsDefault.default).setSignUpHandler(signUpHandler);
};
const loginHandler = async function(e) {
    ...
    if (response.status === "fail") (0, _signViewJsDefault.default).showError(response, "login");
};
const setLoginClickListener = function() {
    (0, _signViewJsDefault.default).setLoginHandler(loginHandler);
};
const init = function() {
...
},{"core-js/modules/web.immediate.js":"49tUX","../signViews/signView.js":"3zZ8N","../signModels/signupModel.js":"6oXAX","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"49tUX":[function(require,module,exports) {
"use strict";
...
},{}],"3zZ8N":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{}],"6oXAX":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "ajaxToServer", ()=>ajaxToServer);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["87DOC","gJH7z"], "gJH7z", "parcelRequire6f3c")

//# sourceMappingURL=uploadClass.fe90e763.js.map
