...
const { signup, login, checkFingerPrint, checkJWT, restrictTo, updatePassword, updateEmailName, checkActivatedSubcourse, logout } = require('./../controllers/authController');
